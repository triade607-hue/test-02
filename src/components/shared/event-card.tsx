...
export function EventCard({ event, index = 0 }: EventCardProps) {
  ...
  // Image avec base URL
  const eventImage = event.banner
    ? getFileUrl(event.banner)
  ...
  return (
    <motion.div
      ...
      className="relative rounded-md overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500 cursor-pointer h-[450px] group"
      style={{
          ...
          >
            ...
            >
              {[
                ...
                { icon: Clock, text: formatTime(event.startDate) },
